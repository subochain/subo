...
public:
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        mixingOnlyCheckBox->setToolTip(QApplication::translate("AskPassphraseDialog", "Serves to disable the trivial sendmoney when OS account compromised. Provides no real security.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mixingOnlyCheckBox->setText(QApplication::translate("AskPassphraseDialog", "Only for mixing via PrivateSend", Q_NULLPTR));
    } // retranslateUi

...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Subo Core after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Subo Core on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        showAdvancedPSUI->setToolTip(QApplication::translate("OptionsDialog", "Show additional information and buttons for PrivateSend on overview screen.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        showAdvancedPSUI->setText(QApplication::translate("OptionsDialog", "Enable advanced PrivateSend interface", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        lowKeysWarning->setToolTip(QApplication::translate("OptionsDialog", "Show warning dialog when PrivateSend detects that wallet has very low number of keys left.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        lowKeysWarning->setText(QApplication::translate("OptionsDialog", "Warn if PrivateSend is running out of keys", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        privateSendMultiSession->setToolTip(QApplication::translate("OptionsDialog", "Whether to use experimental PrivateSend mode with multiple mixing sessions per block.<br/>Note: You must use this feature carefully.<br/>Make sure you always have recent wallet (auto)backup in a safe place!", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        privateSendMultiSession->setText(QApplication::translate("OptionsDialog", "Enable PrivateSend &multi-session", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "PrivateSend rounds to use", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off PrivateSend once it's reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Subo to keep anonymized", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Subo Core client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Subo network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Subo network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Subo Core.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("OptionsDialog", "Language missing or translation incomplete? Help contributing translations.", Q_NULLPTR));

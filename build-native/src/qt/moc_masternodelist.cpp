...
#include "/home/developer/subochain/SuboChain/src/qt/masternodelist.h"
...
QT_MOC_LITERAL(5, 56, 9), // "COutPoint"
QT_MOC_LITERAL(6, 66, 8), // "outpoint"
QT_MOC_LITERAL(7, 75, 16), // "updateMyNodeList"
QT_MOC_LITERAL(8, 92, 6), // "fForce"
QT_MOC_LITERAL(9, 99, 14), // "updateNodeList"
QT_MOC_LITERAL(10, 114, 15), // "showContextMenu"
QT_MOC_LITERAL(11, 130, 29), // "on_filterLineEdit_textChanged"
QT_MOC_LITERAL(12, 160, 11), // "strFilterIn"
QT_MOC_LITERAL(13, 172, 22), // "on_startButton_clicked"
QT_MOC_LITERAL(14, 195, 25), // "on_startAllButton_clicked"
QT_MOC_LITERAL(15, 221, 29), // "on_startMissingButton_clicked"
QT_MOC_LITERAL(16, 251, 48), // "on_tableWidgetMyMasternodes_i..."
QT_MOC_LITERAL(17, 300, 23) // "on_UpdateButton_clicked"
...
void MasternodeList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateMyMasternodeInfo((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< const COutPoint(*)>(_a[3]))); break;

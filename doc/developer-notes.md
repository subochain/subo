...
Subo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Subo Core, where everyone uses
...
pay attention to for reviewers of Subo Core code.
...
- Make sure that constructors initialize all fields. If this is skipped for a
  good reason (i.e., optimization on the critical path), addicitexplicit
  comment about this
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Subo Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
This mechanism has been integrated into Bitcore-Node-Subo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/subochain/insight-api-subo#web-socket-api](https://github.com/subochain/insight-api-subo#web-socket-api)
* API: [https://github.com/subochain/insight-api-subo#instantsend-transactions](https://github.com/subochain/insight-api-subo#instantsend-transactions)
...
By default, the Subo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Subo Core daemon:

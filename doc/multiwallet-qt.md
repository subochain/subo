...
Only requiring some minor changes is subo.cpp.
...
Changes to subo.cpp
----------------------
subo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

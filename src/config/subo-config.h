/* src/config/subo-config.h.  Generated from subo-config.h.in by configure.  */
/* src/config/subo-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SUBO_CONFIG_H

#define SUBO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/subochain/subo/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Subo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Subo Core 1.20.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "subochain"

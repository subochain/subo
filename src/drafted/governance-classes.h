 ...
 *
 *   // network
 *   CSuboNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CSuboNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SuboNetwork
// //   -- signature requirements : Key1(User)
// class CSuboNetworkVariable : public CGovernanceObject
// {
// private:

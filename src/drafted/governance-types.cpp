...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SuboNetwork") type = SuboNetwork;
    if(strType == "SuboNetworkVariable") type = SuboNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SuboNetwork) s = "SuboNetwork";
    if(type == SuboNetworkVariable) s = "SuboNetworkVariable";

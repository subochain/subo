...
{
private:
    // critical section to subo the inner data structures
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 SUBO - checking if valid masternode)

...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Subo related functionality
...
/*
    ...
    allow endless transaction that would bloat Subo and make it unusable. To

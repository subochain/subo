    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Subo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Subo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and subo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Subo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Subo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Subo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Subo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Subo addresses"));
    ...
    openAction->setStatusTip(tr("Open a subo: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Subo Core help message to get a list with possible Subo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Subo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Subo network", "", count));
    } else {
...
{
    QString strTitle = tr("Subo Core"); // default title

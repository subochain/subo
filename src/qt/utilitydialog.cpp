    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Subo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Subo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  subo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Subo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUBO, 0.1 SUBO, 1 SUBO and 10 SUBO -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Subo Core is shutting down...") + "<br /><br />" +
